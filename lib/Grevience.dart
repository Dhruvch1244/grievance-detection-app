...
class _GrievanceState extends State<Grievance> {
  List<GrievanceR> grievances = [
    GrievanceR(
        summary: "Power outage in T nagar area", upvotes: 10, reports: 2),
    ...
    GrievanceR(
        summary: "Traffic jam at yamuna expressway", upvotes: 5, reports: 3),
    GrievanceR(
        summary: "Religious parade going in J nagar", upvotes: 1, reports: 3),
...
class GrievanceR {
  ...
  GrievanceR(
      {required this.summary, required this.upvotes, required this.reports});
}
